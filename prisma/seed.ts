...
async function main() {
  ...
  const paths = await Promise.all([
    ...
    prisma.businessPath.upsert({
      where: { slug: "digital-product-builder" },
      update: {
        name: "Digital Product Builder",
        headline: "Turn your expertise into a product people buy without buying your time",
        description:
          "You take a specific thing you know deeply and turn it into something people can buy and use on their own: a course, a template system, a certification, a toolkit. You build it once, sell it many times, and make money whether or not you're at your desk.",
        ...
        nicheExamples: JSON.stringify([
          "A manager training course for first-time leads at tech companies, with templates and a peer Slack group",
          "A GTM playbook template system for Series A founders launching their first outbound motion",
          "An operations onboarding toolkit that growing companies buy for their entire team",
          "A certification program for RevOps professionals, sold to individuals and L&D teams",
          "A template library for startup CFOs managing board decks, forecasts, and investor updates",
        ]),
        ...
        buyerProfile: JSON.stringify({
          typicalTitle: "Individual professionals investing in themselves, or L&D / team leads buying for their teams",
          companySize: "Individual buyers at all company sizes, or team purchases at 50-500 employee companies",
          triggerEvents: [
            "New to a role and need to ramp fast",
            "Team is scaling and needs shared frameworks",
            "Company is growing faster than their systems can handle",
            "Someone Googling the exact problem your product solves",
          ],
          budgetAuthority: "Under $500: personal spend. $500-$5K: L&D or manager budget.",
          whereTheyHangOut: [
            "LinkedIn (searching for solutions to specific problems)",
            "Google (how-to searches in your niche)",
            "Niche Slack communities and forums",
            "Podcasts and newsletters in your space",
          ],
        }),
        outreachTemplate: "Hey [name],\n\nI've been building something and wanted your gut reaction. You know how [specific problem]? I'm turning [years] of doing that into a [course / toolkit / template system] so people can get the result without hiring someone like me.\n\nWould love 15 minutes to show you what I've got and get your honest take.",
        gutCheckQuestions: JSON.stringify([
          "If this product existed when you started your role, would you have bought it?",
          "What would you expect to pay for something like this?",
          "Where would you look for it? What would you Google?",
          "What's missing from what's already out there?",
          "Would your company buy this for the team, or would individuals buy it themselves?",
        ]),
        order: 10,
      },
      create: {
    ...
    prisma.businessPath.upsert({
      where: { slug: "community-membership-operator" },
      update: {
        name: "Community & Membership Operator",
        headline: "Build a paid community where your network is the product",
        description:
          "You build a curated, paid community around a specific niche where you're the connector and curator, not the service provider. Your professional network, taste, and ability to bring the right people together is the business.",
        whoThisIs: "Connectors who are tired of giving away their best introductions for free.",
        typicalBackground: "Senior professionals who are already the person everyone comes to for intros, advice, and connections. You've built real relationships across your industry and people trust your judgment about who's worth knowing.",
        ...
        businessModel: JSON.stringify({
          ...
          fullTimeMath: "100 members at $200/month + 10 executive members at $1K/month = $30K/month ($360K/year)",
          risk: "Slow initial growth. Communities take 3-6 months to hit critical mass. Need to stay engaged without becoming the sole content creator.",
        }),
        incomeRangeLow: 40000,
        incomeRangeHigh: 400000,
        timelineMonths: 4,
        ...
        nicheExamples: JSON.stringify([
          "A paid Slack community for Heads of Product at Series A-B companies who want a real sounding board",
          "Monthly dinners + private community for women in revenue leadership",
          "An executive peer group for startup COOs navigating the chaos of scaling from 30 to 150 people",
          "A curated membership for independent consultants in a specific vertical sharing leads and best practices",
          "A founders community for working parents in tech, with async support and quarterly retreats",
        ]),
        positioningTemplate: "I run a [type of community] for [type of people] who [shared challenge or goal] - because the best advice comes from peers who are doing the same thing, not from generic networking events.",
        buyerProfile: JSON.stringify({
          typicalTitle: "Mid-to-senior professionals feeling isolated in their role, or companies investing in employee development",
          companySize: "Members: professionals at 50-5,000 person companies. Sponsors: brands selling to your member profile.",
          triggerEvents: [
            "Feeling isolated in a senior role with no real peers",
            "New to a leadership position and looking for a sounding board",
            "Company encouraging professional development spend",
            "Tired of generic networking events and LinkedIn noise",
          ],
          budgetAuthority: "Under $500/month is personal spend for most senior professionals. Above that may need L&D budget approval.",
          whereTheyHangOut: [
            "LinkedIn (publishing and engaging)",
            "Existing professional communities (Pavilion, On Deck, etc.)",
            "Industry conferences and events",
            "Peer referral (the strongest channel for community growth)",
          ],
        }),
        outreachTemplate: "Hey [name],\n\nI'm putting together a small group of [type of professionals] for [monthly dinners / a private Slack / peer roundtables]. The idea is a room where people in [role/function] can talk honestly about [the real challenges] without it being a sales pitch.\n\nYou're exactly who I'd want in the room. Would you be interested?",
        gutCheckQuestions: JSON.stringify([
          "If a community like this existed, would you join it? What would make you actually show up?",
          "What's the one conversation you wish you could have with peers but can't find the right forum for?",
          "How much would you pay monthly for access to a curated group of people like you?",
          "What's the biggest waste of time in your current professional development?",
          "Would your company pay for this, or would you pay out of pocket?",
        ]),
        order: 11,
      },
      create: {
    ...
    prisma.businessPath.upsert({
      where: { slug: "micro-saas-builder" },
      update: {
        name: "Micro-SaaS Builder",
        headline: "Build a small software product that solves one problem really well",
        description:
          "You identify a specific workflow problem you've seen 100 times, use modern tools (including AI) to build a lightweight product, and sell it on a recurring basis. You don't need to be an engineer. You need to understand the problem better than anyone.",
        whoThisIs: "Problem-spotters with enough technical comfort to build (or direct the building of) simple tools.",
        typicalBackground: "Product managers, ops leaders, RevOps professionals, or technically-curious generalists who've spent years watching people struggle with bad tools and manual processes. You've probably already built the spreadsheet or Notion system that your team couldn't live without.",
        ...
        incomeRangeLow: 20000,
        incomeRangeHigh: 600000,
        timelineMonths: 6,
        toolRecommendations: JSON.stringify(["Cursor", "Vercel", "Supabase", "Stripe", "Framer", "PostHog", "Linear"]),
        nicheExamples: JSON.stringify([
          "An automated comp plan calculator for RevOps teams that replaces the spreadsheet nightmare",
          "An AI tool that turns customer support tickets into categorized product feedback",
          "A niche CRM for independent recruiters who need something simpler than Salesforce",
          "A client portal for fractional executives to share updates, docs, and KPIs with their clients",
          "A proposal generator for freelance consultants that builds scoped SOWs from intake forms",
        ]),
        ...
        buyerProfile: JSON.stringify({
          typicalTitle: "End users in the role your tool serves, or their managers who feel the pain",
          companySize: "10-500 employees where the pain point is most acute. Big enough to pay, small enough to adopt without procurement.",
          triggerEvents: [
            "Frustrated with current tool and looking for alternatives",
            "Wasting hours on a manual process every week",
            "Team growing and current workaround is breaking",
            "New manager who wants to fix the mess they inherited",
          ],
          budgetAuthority: "Under $200/month: team lead can expense. $200-$1,000/month: department approval.",
          whereTheyHangOut: [
            "Product Hunt and Hacker News",
            "Reddit communities for their role",
            "Google (searching for solutions to specific problems)",
            "Niche Slack communities and Twitter/X",
          ],
        }),
        outreachTemplate: "Hey [name],\n\nQuick question. I've been building a tool that [solves specific problem] because I kept seeing [type of people] waste hours on [the manual process].\n\nI'm looking for 5-10 people who deal with this to try it out and tell me what's missing. Free for early users. Would you be open to taking a look?",
        gutCheckQuestions: JSON.stringify([
          "How do you currently solve this problem? Walk me through the actual workflow.",
          "How much time does this take you every week/month?",
          "What tools have you tried? Why didn't they work?",
          "If a tool did this perfectly, what would you pay for it monthly?",
          "Who else on your team feels this pain? Would they use something like this?",
          "What would need to be true for you to switch from your current process to a new tool?",
        ]),
        order: 12,
      },
      create: {
  ...
  // ── 10. Digital Product Builder ──────────────────────────────────────
  await createPhasesForPath("digital-product-builder", [
    {
      name: "Find Your Product Idea",
      slug: "find-your-product-idea",
      description: "Before you build anything, you need to know what problem you're solving, who you're solving it for, and whether they'll pay for the solution. These four tasks will get you there.",
      order: 1,
      tasks: [
        {
          slug: "identify-your-productizable-expertise",
          title: "Identify Your Productizable Expertise",
          description: "You've built frameworks, processes, and systems that teams relied on. The question is: which one can you turn into something people buy and use without you in the room?",
          whyItMatters: "The best digital products come from things you've already done 50 times. You're not inventing something new. You're packaging what you know into a format that scales.",
          order: 1,
          taskType: "niche-editor",
          timeEstimate: "~15 min",
        },
        {
          slug: "write-your-product-promise",
          title: "Write Your Product Promise",
          description: "Turn your expertise into a clear promise: 'This [course / toolkit / template] helps [type of person] [achieve specific result] in [timeframe].'",
          whyItMatters: "A product promise that's specific enough to make someone think 'I need that' is the difference between a product that sells and one that sits there. If you can't say who it's for and what they get, it's not ready.",
          order: 2,
          taskType: "positioning-editor",
          timeEstimate: "~10 min",
        },
        {
          slug: "define-your-buyer",
          title: "Define Who Buys This",
          description: "Is your buyer an individual professional investing in themselves? A team lead buying for their team? An L&D department standardizing training? The answer changes everything about how you build and sell.",
          whyItMatters: "Individual buyers decide in minutes and pay with a credit card. Team buyers take weeks and need a business case. Know which one you're building for before you build anything.",
          order: 3,
          taskType: "buyer-profile-editor",
          timeEstimate: "~10 min",
        },
        {
          ...
          description: "Before you spend weeks building a product, talk to 5 people who'd be your ideal buyer. Show them the promise. Ask if they'd buy it. Ask what's missing.",
          whyItMatters: "The #1 reason digital products fail is that someone built what they thought people wanted instead of what people actually wanted. These conversations take 30 minutes and save you months.",
          order: 4,
          taskType: "gut-check",
          timeEstimate: "~30 min",
        },
  ...
  // ── 11. Community & Membership Operator ──────────────────────────────
  await createPhasesForPath("community-membership-operator", [
    {
      name: "Define Your Community",
      slug: "define-your-community",
      description: "Before you launch anything, you need to know who belongs in the room, what they'll get out of it, and why they'd pay to be there. These four tasks will get you there.",
      order: 1,
      tasks: [
        {
          slug: "find-your-community-niche",
          title: "Find Your Community Niche",
          description: "You already connect people naturally. The question is: which specific group of people would pay to be in a room you curate? Think about who comes to you for intros, advice, and honest conversation.",
          whyItMatters: "Generic communities die. Specific ones thrive. 'A community for women in tech' is too broad. 'A peer group for Heads of Product at Series A-B companies' is a business.",
          order: 1,
          taskType: "niche-editor",
          timeEstimate: "~15 min",
        },
        {
          ...
          description: "Turn your community concept into one sentence: 'A [type of community] for [specific people] who want [what they can't get anywhere else].'",
          whyItMatters: "If someone reads this sentence and immediately thinks 'I need to be in that room,' you've got it. If they think 'that's nice,' it's too vague.",
          order: 2,
          taskType: "positioning-editor",
          timeEstimate: "~10 min",
        },
        {
          slug: "profile-your-founding-members",
          title: "Profile Your Founding Members",
          description: "Your first 10-20 members define the community forever. Who are they? What titles, what companies, what challenges? And most importantly: do you already know 10 of them?",
          whyItMatters: "A community is only as good as its members. If you can name 10 people who'd join tomorrow, you have a business. If you can't, you need to narrow your niche until you can.",
          order: 3,
          taskType: "buyer-profile-editor",
          timeEstimate: "~10 min",
        },
        {
          slug: "test-the-concept",
          title: "Test the Concept",
          description: "Before you build infrastructure, host one event. A dinner, a virtual roundtable, a Slack pop-up. Invite 8-10 people and see what happens.",
          whyItMatters: "One good conversation proves the concept better than any business plan. If people show up, stay engaged, and ask 'when's the next one?', you have your answer.",
          order: 4,
          taskType: "gut-check",
          timeEstimate: "~30 min",
        },
  ...
  // ── 12. Micro-SaaS Builder ──────────────────────────────────────────
  await createPhasesForPath("micro-saas-builder", [
    {
      name: "Find Your Problem",
      slug: "find-your-problem",
      description: "Before you write a line of code, you need to find a specific problem that specific people have, that they'd pay to solve, that you understand from the inside. These four tasks will get you there.",
      order: 1,
      tasks: [
        {
          slug: "spot-the-broken-workflow",
          title: "Spot the Broken Workflow",
          description: "Think about every manual process, spreadsheet hack, or 'I can't believe there's no tool for this' moment you've had in your career. Which one is a real business?",
          whyItMatters: "The best micro-SaaS products solve problems the builder has personally experienced. You don't need to be creative. You need to remember what frustrated you and check if it frustrates other people too.",
          order: 1,
          taskType: "niche-editor",
          timeEstimate: "~15 min",
        },
        {
          slug: "write-your-product-thesis",
          title: "Write Your Product Thesis",
          description: "Turn your problem into a thesis: '[Type of person] wastes [X hours] every [week/month] on [manual process] because [existing tools don't solve it]. I'll build [simple description] that fixes this.'",
          whyItMatters: "This is your filter for every decision you'll make. If a feature doesn't serve this thesis, don't build it. If a customer doesn't match this profile, don't chase them.",
          order: 2,
          taskType: "positioning-editor",
          timeEstimate: "~10 min",
        },
        {
          slug: "find-your-first-10-users",
          title: "Find Your First 10 Users",
          description: "Who specifically would use this? Where do they hang out? Can you find 10 of them and talk to them before you build anything?",
          whyItMatters: "If you can't find 10 people who have this problem, you don't have a product. If you can find 10 easily, you probably have hundreds or thousands of potential users.",
          order: 3,
          taskType: "buyer-profile-editor",
          timeEstimate: "~10 min",
        },
        {
          ...
          description: "Talk to 5 potential users. Don't pitch your solution. Ask about the problem. How do they solve it now? How much time does it take? What have they tried?",
          whyItMatters: "You're looking for people who light up when you describe the problem. 'Oh my god, yes, we deal with that every week.' That's the signal. If they shrug, it's not painful enough to pay for.",
          order: 4,
          taskType: "gut-check",
          timeEstimate: "~30 min",
        },
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Led full brand repositioning for a growing med spa chain",
        "Built messaging frameworks that turned confused brands into clear stories",
        "Audited website copy and delivered conversion-focused rewrites",
        "Created positioning packages for agency clients across retail and wellness",
        "Developed brand voice guidelines used across sales and marketing teams",
        "Turned founder interviews into compelling brand narratives",
        "Built pitch decks that helped clients close funding rounds",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Built outbound pipeline from scratch for Stripe's mid-market segment",
        "Designed enterprise sales process for 6+ month deal cycles at $100K-$500K ACV",
        "Created partner enablement program that generated 30% of new pipeline",
        "Led territory planning and account prioritization for enterprise team",
        "Built QBR framework and forecasting model used across the sales org",
        "Trained and onboarded 5+ enterprise AEs on complex deal management",
        "Managed multi-stakeholder procurement cycles with legal and security reviews",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Built operational infrastructure that scaled a team from 40 to 200 people",
        "Designed hiring processes that cut time-to-fill by 40%",
        "Created onboarding program that got new hires productive in half the time",
        "Led cross-functional process redesign across engineering, sales, and CS",
        "Built vendor management system that saved $500K annually",
        "Ran company-wide OKR process and strategic planning",
        "Managed board reporting and investor updates",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Led full CRM migration for a 500-person org with zero downtime",
        "Built automation workflows that saved 20+ hours/week across sales and ops",
        "Designed lead routing and assignment logic that increased speed-to-lead by 60%",
        "Created custom Salesforce dashboards for executive reporting",
        "Integrated 5+ tools into a unified revenue operations stack",
        "Built employee onboarding automation that eliminated 15 manual steps",
        "Documented and standardized business processes across 3 departments",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Built content engine that drove 40% of inbound pipeline for a B2B SaaS company",
        "Managed editorial calendar across blog, newsletter, and social for 50K+ audience",
        "Ghostwrote thought leadership content for 3 C-suite executives",
        "Created content repurposing system that turned 1 piece into 8 distribution formats",
        "Launched company podcast that reached top 10% in its category",
        "Built SEO strategy that doubled organic traffic in 6 months",
        "Managed freelance content team of 4 writers and 2 designers",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Built paid acquisition strategy that generated $2M+ pipeline annually",
        "Managed $500K/quarter ad budget across Google, LinkedIn, and Meta",
        "Designed lead scoring model that improved sales acceptance rate by 35%",
        "Created automated email nurture sequences with 40%+ open rates",
        "Built attribution model connecting marketing spend to closed revenue",
        "Launched ABM campaigns targeting enterprise accounts with 15% response rate",
        "Optimized landing pages that doubled conversion from 2% to 4%",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Led product redesign that increased user activation by 25%",
        "Built design system used across 3 product teams and 12 designers",
        "Created user research program from scratch - recruited, interviewed, synthesized",
        "Designed onboarding flows that reduced time-to-value by 50%",
        "Built rapid prototyping process that cut design cycles from weeks to days",
        "Led accessibility audit and redesign for WCAG compliance",
        "Created design sprint methodology adopted across the company",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Built engineering recruiting pipeline that filled 50+ roles in 18 months",
        "Designed technical interview process that improved offer acceptance by 30%",
        "Created employer brand content strategy that doubled inbound applications",
        "Led executive search for VP and C-level hires across 3 companies",
        "Built referral program that generated 40% of all hires",
        "Managed recruiting team of 5 across multiple time zones",
        "Created compensation benchmarking framework used for all offers",
      ]),
    },
  });
  ...
  await prisma.userProfile.upsert({
    ...
    create: {
      ...
      notableExperience: JSON.stringify([
        "Led financial modeling for $50M Series C fundraise",
        "Built board reporting package used across 3 portfolio companies",
        "Conducted due diligence on 10+ acquisition targets",
        "Created FP&A function from scratch at a Series B startup",
        "Managed $15M annual budget with quarterly reforecasting",
        "Built financial dashboards that replaced 20+ manual spreadsheets",
        "Designed pricing strategy that increased ACV by 30%",
      ]),
    },
  });
